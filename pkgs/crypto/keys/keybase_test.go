...
func TestKeyManagement(t *testing.T) {
	...
	_, err = cstore.Get(n1)
	require.Error(t, err)
	i, err := cstore.CreateAccount(n1, mn1, bip39Passphrase, p1, "ed25519", 0, 0)
	require.NoError(t, err)
	require.Equal(t, n1, i.GetName())
	_, err = cstore.CreateAccount(n2, mn2, bip39Passphrase, p2, "ed25519", 0, 0)
	require.NoError(t, err)
...
func TestSignVerify(t *testing.T) {
	...
	i1, err := cstore.CreateAccount(n1, mn1, bip39Passphrase, p1, "ed25519", 0, 0)
	require.Nil(t, err)

	i2, err := cstore.CreateAccount(n2, mn2, bip39Passphrase, p2, "ed25519", 0, 0)
	require.Nil(t, err)
...
func TestExportImport(t *testing.T) {
	...
	info, err := cstore.CreateAccount("john", mn1, bip39Passphrase, "secretcpw", "ed25519", 0, 0)
	require.NoError(t, err)
...
func TestExportImportPubKey(t *testing.T) {
	...
	bip39Passphrase := ""
	notPasswd := "n9y25ah7"
	info, err := cstore.CreateAccount("john", mn1, bip39Passphrase, notPasswd, "ed25519", 0, 0)
	require.Nil(t, err)
...
func TestAdvancedKeyManagement(t *testing.T) {
	...
	_, err := cstore.CreateAccount(n1, mn1, bip39Passphrase, p1, "ed25519", 0, 0)
	require.Nil(t, err, "%+v", err)
...
func TestSeedPhrase(t *testing.T) {
	...
	// make sure key works with initial password
	info, err := cstore.CreateAccount(n1, mn1, bip39Passphrase, p1, "ed25519", 0, 0)
	require.Nil(t, err, "%+v", err)
...
func ExampleNew() {
	...
	bob, err := cstore.CreateAccount("Bob", mn1, bip39Passphrase, "friend", "ed25519", 0, 0)
	if err != nil {
	...
	_, _ = cstore.CreateAccount("Alice", mn2, bip39Passphrase, "secret", "ed25519", 0, 0)
	_, _ = cstore.CreateAccount("Carl", mn3, bip39Passphrase, "mitm", "ed25519", 0, 0)
	info, _ := cstore.List()
	for _, i := range info {
